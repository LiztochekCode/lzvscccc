...
Adding a Programming Language to the extention is easy, you can either add it to the repository OR define it in `liztochekvsc.additionalFileMapping`.

To make the language appear you need to add it extension to the language data json or `liztochekvsc.additionalFileMapping`, then to make icon appear you need to add it to [assets/icons/](/assets/icons/).
